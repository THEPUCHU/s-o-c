...
st.markdown("""
    ...
    .action-log { font-family: 'Courier New', monospace; color: #ff8c00; background: #0a0a0a; padding: 15px; border-radius: 5px; border: 1px solid #333; border-left: 4px solid #ff6600; line-height: 1.6; }
    .action-log-failed { font-family: 'Courier New', monospace; color: #ff8c00; background: #2a0808; padding: 15px; border-radius: 5px; border: 1px solid #ef4444; border-left: 4px solid #ef4444; line-height: 1.6; }
    ...
    .attack-node { background: #111; border: 1px solid #ff6600; border-radius: 8px; padding: 10px; text-align: center; margin-bottom: 10px; box-shadow: 0 0 10px rgba(255, 102, 0, 0.2); }
    .attack-node-failed { background: #2a0808; border: 1px solid #ef4444; border-radius: 8px; padding: 10px; text-align: center; margin-bottom: 10px; box-shadow: 0 0 10px rgba(239, 68, 68, 0.4); }
...
if st.session_state.swarm_ran:
    ...
    if st.session_state.final_results:
        ...
        if is_catastrophic:
            ...
            real_tools = agg_data.get("tools", ["VirusTotal API v3", "Cloudflare API v4", "OSV.dev Vulnerability API"])
        ...
        with pr_col:
            ...
            # Interactive Merge Button Logic
